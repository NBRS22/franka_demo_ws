...
# This file is a robot_type:=fp3 adaptation of
# franka_fr3_moveit_config/launch/moveit.launch.py. It does not modify or
# depend on franka_fr3_moveit_config; it only reuses the shared
# franka_bringup/franka_gripper launch files, same as the fr3 version does.
...
def generate_launch_description():
    ...
    kinematics_yaml = load_yaml(
        'franka_fp3_moveit_config', 'config/kinematics.yaml'
    )
    ...
    joint_limits_yaml = load_yaml(
        'franka_fp3_moveit_config', 'config/fp3_joint_limits.yaml'
    )
    ...
    ompl_planning_yaml = load_yaml(
        'franka_fp3_moveit_config', 'config/ompl_planning.yaml'
    )
    ompl_planning_pipeline_config['move_group'].update(ompl_planning_yaml)

    # Trajectory Execution Functionality
    moveit_simple_controllers_yaml = load_yaml(
        'franka_fp3_moveit_config', 'config/fp3_controllers.yaml'
    )
    moveit_controllers = {
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory('franka_fp3_moveit_config'),
        'config',
        'fp3_ros_controllers.yaml',
    )
    ...
    joint_state_publisher = Node(
        ...
        namespace=namespace,
        parameters=[
            {'source_list': ['franka/joint_states', 'fp3_gripper/joint_states'], 'rate': 30}],
    )
