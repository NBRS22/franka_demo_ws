> **FP3 project:** this copy includes changes for the FP3 pick pipeline (ZMQ server with collision filtering). See [`README_FP3.md`](README_FP3.md) for setup and usage.
...
python client-server/graspgen_client.py --mesh_file /path/to/mesh.obj --host localhost --port 5558
```
