...
# franka_fr3_moveit_config/launch/move_group.launch.py (headless move_group
# only, to be included alongside franka_bringup's franka.launch.py). It does
# not modify or depend on franka_fr3_moveit_config.
...
def load_yaml(package_name, file_path, prefix=None):
    ...
    try:
        with open(absolute_file_path, 'r') as file:
            ...
            if prefix:
                yaml_string = yaml_string.replace('fp3', prefix + '_fp3')
...
def generate_robot_nodes(context, *args, **kwargs):
    ...
    kinematics_yaml = load_yaml(
        'franka_fp3_moveit_config', 'config/kinematics.yaml', prefix_str)
    ...
    joint_limits_yaml = load_yaml(
        'franka_fp3_moveit_config', 'config/fp3_joint_limits.yaml', prefix_str
    )
    ...
    moveit_simple_controllers_yaml = load_yaml(
        'franka_fp3_moveit_config', 'config/fp3_controllers.yaml', prefix_str
    )
    moveit_controllers = {
