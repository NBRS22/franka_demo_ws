> **FP3 project:** this directory also contains the ZMQ segmentation server used by the FP3 pick pipeline. See [`README_FP3.md`](README_FP3.md) for setup and usage.
