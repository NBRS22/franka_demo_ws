...
def zmq_camera_url() -> str:
    return os.environ.get("ZMQ_CAMERA_URL", "tcp://localhost:5556")


def zmq_robot_url() -> str:
    return os.environ.get("ZMQ_ROBOT_URL", "tcp://localhost:5559")


def zmq_robot_timeout_ms() -> int:
    return int(os.environ.get("ZMQ_ROBOT_TIMEOUT_MS", "120000"))
...
def backend_port() -> int:
    return int(os.environ.get("BACKEND_PORT", "8889"))
